    ...
    if (props.icon == 'euro') {
        return <div>
            ...
            <div className={'Input' + ' ' + props.iconDirection}>
                ...
                <input type="number" name={props.inputName} onChange={sendMortgageAmount}/>
            </div>
        </div>
        ...
        return <div>
            ...
            <div className={'Input' + ' ' + props.iconDirection}>
                ...
                <input type="number" name={props.inputName} onChange={sendMortgageTerm}/>
            </div>
        </div>
        ...
        return <div>
            ...
            <div className={'Input' + ' ' + props.iconDirection}>
                ...
                <input type="number" name={props.inputName} onChange={sendInterestRate}/>
            </div>
        </div>
    }
}
